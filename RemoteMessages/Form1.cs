...
namespace RemoteMessages
{
    public partial class Form1 : Form
    {
        ...
        private void saveDraft()
        {
            ...
            string currentContact = findCurrentContact();
            if (currentContact != "")
            {
        ...
        {
            string contact = findCurrentContact();
        ...
        private void ConversationChanged()
        {
            ...
            if (isReplacing)
            {
                ...
                {
                    t1 = new Timer();
                    t1.Interval = delayReplacing;
                    t1.Enabled = true;
                    t1.Tick += new EventHandler(ConversationChangedTimer);
                    t1.Start();
                }
            }
        }
